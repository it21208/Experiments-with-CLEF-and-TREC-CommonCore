...
if __name__ == '__main__':
    ...
    # changed 27 october 2020 by alexandros ioannidis
    if collection == 'clef171819':
        qid2text = {}
        queries = open(ftopic, 'r').readlines()
        for query in queries:
            qid2text[query.split(" ", 1)[0]] = query.split(" ", 1)[1].rstrip()
    else: 
        qid2text = get_query(ftopic, collection=collection)

    # print('qid2text = ', qid2text)
