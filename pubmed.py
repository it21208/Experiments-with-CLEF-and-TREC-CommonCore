...
class Pubmed(TabularDataset):
    ...
    @classmethod
    def splits(cls, path, train=os.path.join('Pubmed', 'train.tsv'),
               validation=os.path.join('Pubmed', 'dev.tsv'),
               test=os.path.join('Pubmed', 'test.tsv'), **kwargs):
        return super(Pubmed, cls).splits(
